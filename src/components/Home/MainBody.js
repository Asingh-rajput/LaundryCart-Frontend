...
function MainBody() {
    ...
    const sendData = (data) => {
        fetch("https://laundry-crt-backend.onrender.com/register", {
            method: "POST",
            headers: {
    ...
    const signIn = (e) =>{
        e.preventDefault()
        fetch("https://laundry-crt-backend.onrender.com/signin",{
            method:"POST",
            headers:{
                "Content-Type":"application/json"
            },
        ...
        .then(result=>{
            ...
            if(result.token){
                ...
                M.toast({html:"successfully logged in",classes:"#1976d2 blue darken-2"})
                // setEmail("")
                // setPassword("")
    ...
    return <>
        ...
        <section id="main-body">
            <section id="laundry-section">
                ...
                {registerPage ? <h6>Already Have An Account?</h6> : <h6>Don't Have An Account?</h6>}

                {!registerPage && <button style={{ float: "left", marginLeft: "10px" }} onClick={() => showRegisterPage(true)}>Register</button>}
                {registerPage && <button style={{ float: "left", marginLeft: "10px" }} onClick={() => showRegisterPage(false)}>Sign in</button>}
            </section>
            {!registerPage && <section id="form-section">
                <h3>SIGN IN</h3>
                ...
                <form  onSubmit={(e)=>signIn(e)}>
                    ...
                    <div >
                        <button style={{ position: "relative", left: "80px",top:"30px", backgroundColor: "#4552C1" }} className="btn" type="submit">Signin
                        </button>
                    </div>
            ...
            {registerPage && <section>
                <h3 style={{ position: "relative", top: "-90px", color: "#5861AE" }}>Register</h3>
                ...
                <form id="register-form" onSubmit={e => { submitHandler(e) }}>
                    ...
                    <div className="checkbox-container">
                        ...
                        <span style={{ fontSize: ".7rem", position: "relative", top: "-9px", left: "-5px", color: "#5861AE" }}>I agree to Terms & Condition receiving marketing and promotional materials</span>
                    </div>
                    <div >
                        <button style={{ position: "relative", left: "-200px", backgroundColor: "#4552C1" }} className="btn" type="submit">Register
                        </button>
                    </div>
                </form>
        ...
        <footer>
            <div className="terms">
                <p style={{ fontSize: "16px", color: "#5861AE" }}>Now Refer & Earn ₹500 for every referral*</p>
                <p style={{ fontSize: "10px" }}>* Terms and conditions will be applied</p>
            </div>
            <div className="links">
                <h5>ABOUT US</h5>
